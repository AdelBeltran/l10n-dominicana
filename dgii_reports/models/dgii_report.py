...
class DgiiReport(models.Model):
    ...
    def _generate_606_txt(self, records, qty):
        ...
        file_path = 'C:/tmp/DGII_606_{}_{}.txt'.format(company_vat, period)
    ...
    def _process_op_dict(self, args, invoice):
        ...
        if invoice.move_type == 'out_refund' and not invoice.debit_note_count == 0: # nd nota de debito cambiado por debit_note
